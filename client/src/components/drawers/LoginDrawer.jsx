import { Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, Button, Box, Alert, AlertIcon, AlertDescription, Text, AlertTitle, HStack, Center, useTheme } from '@chakra-ui/react'
import { message, Steps, Card, theme } from 'antd'
...
const LoginDrawer = ({ onAccountAddressChange, onNftDetails }) => {
  const [isOpen, setIsOpen] = React.useState(false)
  const { account, setAccount, logged, setLogged, avatarImage, setAvatarImage, signature, setSignature, setAccountAddress, accountAddress } =
  ...
  const goTab2 = () => {
    setTabIndex(1) // Switch to tab 2
  }

  const goTab3 = () => {
    setTabIndex(2) // Switch to tab 3
  }
